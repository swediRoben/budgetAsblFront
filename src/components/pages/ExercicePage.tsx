...
export default function renderExercicePage() {
  ...
  const handleToggleExercice = (name: "preparation" | "execution" | "cloture") => {
    // Décocher toutes les cases
    setValue("preparation", false);
    setValue("execution", false);
    setValue("cloture", false);
                ...
                <label className="flex items-center justify-between gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 cursor-pointer hover:shadow-sm transition">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={() => handleToggleExercice("preparation")}
                ...
                <label className="flex items-center justify-between gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 cursor-pointer hover:shadow-sm transition">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={() => handleToggleExercice("execution")}
                      className="peer sr-only"
                    />
                ...
                <label className="flex items-center justify-between gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 cursor-pointer hover:shadow-sm transition">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={() => handleToggleExercice("cloture")}
                      className="peer sr-only"
                    />
          ...
          <tbody>
            {exercices?.map((exercice, index: any) => (
              <tr key={exercice.id} className="hover:bg-gray-50">
                ...
                <td className="border border-gray-300 px-4 py-2">
                  <span className={`px-2 py-1 rounded-full text-xs ${exercice.cloture === false
