...
export default function renderEtatVentillationPage() {
  ...
  return (
    <> 
      ...
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Ventilation</h2>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border border-gray-300 px-4 py-2 text-left">BANQUE</th>
              <th className="border border-gray-300 px-4 py-2 text-left">CAISSE</th>
              <th className="border border-gray-300 px-4 py-2 text-left">TOTAL</th>
                </tr>
          </thead>
          <tbody>
            {etatsvantilation?.map((data) => (
              <tr key={data.id} className="hover:bg-gray-50">
                <td className="border border-gray-300 px-4 py-2">{data.projet.libelle}</td>
                <td className="border border-gray-300 px-4 py-2 font-medium">{data.banque}</td>
                <td className="border border-gray-300 px-4 py-2">{data.caisse}</td>
                <td className="border border-gray-300 px-4 py-2">{data.banque-data.caisse}</td>   
              </tr>
            ))}
          </tbody>
        </table>
