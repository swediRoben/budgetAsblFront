      ...
      <form onSubmit={handleSubmitBanque(onSubmitBanque)} className='p-6'>
        <div className="mb-4">
          ...
          <input {...registerBanque("libelle", { required: "nom de la banque est obligatoire" })}
            className={`w-full border px-4 py-2 rounded focus:outline-none focus:border-blue-500 ${errorsBanque.libelle ? "border-red-500" : "border-gray-300"
              }`}
        ...
        <div className="mb-4">
          ...
          <select {...registerBanque("idCompteComptable", { required: "Compte est obligatoire" })}
            ...
            className={`w-full border px-4 py-2 rounded focus:outline-none focus:border-blue-500 ${errorsBanque.idCompteComptable ? "border-red-500" : "border-gray-300"
              }`}>
