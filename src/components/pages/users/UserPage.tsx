      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border px-4 py-2 rounded focus:outline-none focus:ring-2 ${errors.username ? "border-red-500 focus:ring-red-300" : "border-gray-300 focus:ring-blue-300"
              }`}
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border px-4 py-2 rounded focus:outline-none focus:ring-2 ${errors.password ? "border-red-500 focus:ring-red-300" : "border-gray-300 focus:ring-blue-300"
              }`}
            placeholder="******"
          />
        ...
        <div>
          ...
          <select
            ...
            className={`w-full border px-4 py-2 rounded focus:outline-none ${errors.idRole ? "border-red-500" : "border-gray-300"
              }`}
          >
        ...
        <div>
          ...
          <select
            ...
            className={`w-full border px-4 py-2 rounded focus:outline-none ${errors.idFonctionnaire ? "border-red-500" : "border-gray-300"
              }`}
          >
            ...
            {Users?.map((user, index) => (
              <tr key={user.id} className="hover:bg-gray-50 transition">
                ...
                <td className="border px-4 py-2 text-center">
                  <span
                    className={`px-2 py-1 rounded text-xs font-semibold ${user.actif
