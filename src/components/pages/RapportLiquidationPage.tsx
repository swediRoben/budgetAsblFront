...
import { getAllValiderLiqidation, getAllReceptionner, getAllRejeter, getAllRetourne, getAllEnAttente } from "../../data/execution/liquidation";
...
const totalMontantLocal = Liquidations.reduce((sum, item) => {
        ...
        <tbody className="text-xs text-gray-800">
          {Liquidations.map((item) => (
            <tr key={item} className="odd:bg-white even:bg-gray-50">
              ...
              <td className="border border-gray-300 px-3 py-2 font-mono font-bold">{item.bonEngagment}</td>
