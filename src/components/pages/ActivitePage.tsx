    ...
    return (
      <form onSubmit={handleSubmitActivite(onSubmitActivite)} className='p-6'>
        <div className="mb-4">
          ...
          <select {...registerActivite("projetId", { required: "Projet obligatoire" })} className={`w-full border px-4 py-2 rounded focus:outline-none focus:border-blue-500 ${errorsActivite.projet ? "border-red-500" : "border-gray-300"
        ...
        <div className="mb-4">
          ...
          <select {...registerActivite("categorieId", { required: "Catégorie obligatoire" })} className={`w-full border px-4 py-2 rounded focus:outline-none focus:border-blue-500 ${errorsActivite.categorie ? "border-red-500" : "border-gray-300"
            }`}
        ...
        <div className="mb-4">
          ...
          <input
            {...registerActivite("code", { required: "Code obligatoire" })}
        ...
        <div className="mb-4">
          ...
          <input {...registerActivite("libelle", { required: "Intitulé obligatoire" })} className={`w-full border px-4 py-2 rounded focus:outline-none focus:border-blue-500 ${errorsActivite.libelle ? "border-red-500" : "border-gray-300"
            }`} />
